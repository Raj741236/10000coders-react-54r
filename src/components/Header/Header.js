...
class Header extends React.Component {
  render() {
    return (
        ...
        <div style={{flex:1}}>
            <img src="https://www.10000coders.co/assets/10000coders-logo.png?v=1.0" alt="10000coders_logo"/>
        </div>
        <nav style={{flex:11}}>
            <ul style={{display:'flex',listStyleType:'none',cursor:'pointer'}}>
                ...
                <li style={{flex:1}}><Link to="/placement" style={{textDecoration:'none',color:'white'}}>Placement</Link></li>
            </ul>
        </nav>
    </header>
    );
